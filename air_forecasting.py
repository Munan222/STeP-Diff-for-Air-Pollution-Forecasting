...
class Forecasting_Dataset(Dataset):
    def __init__(self, datatype, mode="train"):
        ...
        # datafolder = './DataAir/forecast/Nanjing'
        # datafolder = './DataAir/forecast/Changshu'
        datafolder = './DataAir/forecast/NJ mobile with deeponet'
        # datafolder = './DataAir/forecast/CS mobile with deeponet'
        # datafolder = './DataAir/forecast/NJ mobile with deeponet add12h'
        # datafolder = './DataAir/forecast/NJ with PDE'
        # datafolder = './DataAir/forecast/NJ DeepONet PDE'

        # datafolder = './DataAir/forecast/NJ PDE 4city'
        # datafolder = './DataAir/forecast/NJ DeepONet PDE4city'
        # datafolder = './DataAir/forecast/NJ DeepONet_PDEloss'

        # datafolder = './DataAir/forecast/NJ noise'


        self.test_length = 2*24
        self.valid_length = 2*24
...
class Stations_Dataset(Dataset):
    def __init__(self, datatype, mode="train"):
        # self.history_length = 168
        # self.pred_length = 24
        ...
        # datafolder = './DataAir/forecast/NJ station'
        # datafolder = './DataAir/forecast/CS station'
        # datafolder = './DataAir/forecast/NJ mobile with deeponet'
        # datafolder = './DataAir/forecast/CS mobile with deeponet'
        # datafolder = './DataAir/forecast/NJ mobile with deeponet add12h'
        # datafolder = './DataAir/forecast/NJ with PDE'
        ...
        # datafolder = './DataAir/forecast/NJ DeepONet PDE4city'
        # datafolder = './DataAir/forecast/NJ DeepONet_PDEloss'
        datafolder = './DataAir/forecast/NJ station DeepONet'

        # datafolder = './DataAir/forecast/NJ station PDE4city'
        # datafolder = './DataAir/forecast/NJ station DeepONet_PDEloss'
        # datafolder = './DataAir/forecast/NJ station DeepONet PDE4city'
        # datafolder = './DataAir/forecast/NJ station noise'
...
class DeepONet_Dataset(Dataset):
    def __init__(self, datatype, mode="train"):
        ...
        # datafolder = './DataAir/forecast/NJ station'
        # datafolder = './DataAir/forecast/CS deeponet'
        # datafolder = './DataAir/forecast/NJ mobile with deeponet'
        # datafolder = './DataAir/forecast/CS mobile with deeponet'
        # datafolder = './DataAir/forecast/NJ mobile with deeponet add12h'
        # datafolder = './DataAir/forecast/NJ with PDE'
        # datafolder = './DataAir/forecast/NJ DeepONet PDE'
        # datafolder = './DataAir/forecast/NJ PDE4city'
        # datafolder = './DataAir/forecast/NJ DeepONet_PDEloss'
        datafolder = './DataAir/forecast/NJ station DeepONet'
...
def get_dataloader(datatype,device,batch_size=8):
    ...
    # Stations_dataset = Stations_Dataset(datatype,mode='test')
    # Stations_loader = DataLoader(
    #     Stations_dataset, batch_size=batch_size, shuffle=0)

    '''
    CSDI+ DeepONet mobile 
    '''
    # dataset = Forecasting_Dataset(datatype,mode='train')
    # train_loader = DataLoader(
    #     dataset, batch_size=batch_size, shuffle=1)
    ...
    #     valid_dataset, batch_size=batch_size, shuffle=0)
    # # test_dataset = Forecasting_Dataset(datatype,mode='test')
    # test_dataset = DeepONet_Dataset(datatype,mode='test')
    # test_loader = DataLoader(
    #     test_dataset, batch_size=batch_size, shuffle=0)

    '''
    CSDI+ DeepONet station
    '''
    # dataset = Forecasting_Dataset(datatype,mode='train')
    # train_loader = DataLoader(
    #     dataset, batch_size=batch_size, shuffle=1)
    ...
    # return train_loader, valid_loader, test_loader, scaler, mean_scaler, Stations_loader
